...
impl<ElementId, PressedId, ReleasedId> From<Rectangle<ElementId, PressedId, ReleasedId>>
    for GuiElement<ElementId, PressedId, ReleasedId>
where
    ElementId: Copy,
    PressedId: Copy,
    ReleasedId: Copy,
...
impl<ElementId, PressedId, ReleasedId> From<VerticalLayout<ElementId, PressedId, ReleasedId>>
    for GuiElement<ElementId, PressedId, ReleasedId>
where
    ElementId: Copy,
    PressedId: Copy,
...
impl<ElementId, PressedId, ReleasedId> From<HorizontalLayout<ElementId, PressedId, ReleasedId>>
    for GuiElement<ElementId, PressedId, ReleasedId>
where
    ElementId: Copy,
    PressedId: Copy,
